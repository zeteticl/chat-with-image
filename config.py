...
Requirements:
1. Must include Hong Kong background elements
2. Must be TRPG related
3. Must be in English only
4. don't include any other text ,explanations and response 
5. only return this exact format in English only and without title:
